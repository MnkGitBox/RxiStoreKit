...
public struct ReceiptInApp: Decodable {
    ...
    /*
     ...
     See [in_app_ownership_type](https://developer.apple.com/documentation/appstorereceipts/in_app_ownership_type) for more information.
     */
    var inAppOwnershipType: IAPOwnershipType!
    ...
    /*
     ...
     For more information about offer codes,
     see [Set Up Offer Codes](https://help.apple.com/app-store-connect/#/dev6a098e4b1)
     ...
     [offer_code_ref_name](https://developer.apple.com/documentation/appstorereceipts/offer_code_ref_name)
     */
